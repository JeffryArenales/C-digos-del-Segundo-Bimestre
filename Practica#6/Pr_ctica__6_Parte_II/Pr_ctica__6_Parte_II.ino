/* 
  Fundación Kinal
    ...
    Proyecto: Práctica No.6 Parte II
...
String contrasenaCerradura = "2020199*";   //Variable donde almaceno la contraseña definida por el sistema
...
//Constructor
LiquidCrystal_I2C lcdCerradura(direccion_lcd, columnas, filas);   //LCD con direccion 0x27 y tamanio 16x2
...
void setup()
{
  ...
  Serial.println("Practica 6 - Parte II");   //Envio el mensaje al monitor serie
