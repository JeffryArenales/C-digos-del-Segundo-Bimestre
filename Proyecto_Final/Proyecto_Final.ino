...
#define pin_servo 7            // pin del servomotor 
...
void setup() {
  ...
  lcd.init();              //impresión de la pantalla lcd
  lcd.backlight(); 
  lcd.setCursor(3,0);
  lcd.print("Jeffry A.");
  lcd.setCursor(0,1);
...
void loop() {
  ...
  if (key == '3') {            //leds tipo auto fantastico
